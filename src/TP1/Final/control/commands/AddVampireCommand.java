...
public class AddVampireCommand extends Command{
	...
	public boolean execute(Game game) throws CommandExecuteException{
		...
		catch(DraculaIsAliveException | NoMoreVampiresException | UnvalidPositionException e) {
			throw new CommandExecuteException(String.format("%s[ERROR]: Failed to add this vampire", e.getMessage()));
		}
